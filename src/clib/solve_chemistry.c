...
extern void FORTRAN_NAME(solve_rate_cool_g)(
	...
	int *in, int *jn, int *kn, int *nratec, int *iexpand,
        int *ispecies, int *imetal, int *imcool, int *idust, int *ifdust, int *idim,
...
int _solve_chemistry(chemistry_data *my_chemistry,
					 ...
					 gr_float (*Metallicity)[11], gr_float (*dust_Metallicity)[11], gr_float *SNe_ThisTimeStep)
{
                          ...
                          double dt_value)
{
  if (_solve_chemistry(my_chemistry, my_rates,
					   ...
					   my_fields->Metallicity, my_fields->dust_Metallicity,
					   my_fields->SNe_ThisTimeStep) == FAIL) {
